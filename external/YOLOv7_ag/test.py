...
from YOLOv7_ag.utils.metrics import ap_per_class, ConfusionMatrix
from YOLOv7_ag.utils.plots import plot_images, output_to_target, plot_study_txt
...
def test(
    ...
    if training:  # called by train_vit.py
