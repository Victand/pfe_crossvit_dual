...
from YOLOv7_ag.utils.datasets import LoadStreams, LoadImages
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if (
                            object_name == "stamp"
                            or object_name == "ColorPalet"
                            or object_name == "ScaleBar"
                            or object_name == "TextBox"
                            or object_name == "Envelope"
                        ):
