...
import YOLOv7_ag.test as test  # import test.py to get mAP after each epoch
from YOLOv7_ag.models.experimental import attempt_load
from YOLOv7_ag.models.yolo import Model
from YOLOv7_ag.utils.autoanchor import check_anchors
from YOLOv7_ag.utils.datasets import create_dataloader
from YOLOv7_ag.utils.general import (
...
from YOLOv7_ag.utils.google_utils import attempt_download
from YOLOv7_ag.utils.loss import ComputeLoss, ComputeLossOTA
from YOLOv7_ag.utils.plots import (
    plot_images,
    plot_results,
    plot_evolution,
)
from YOLOv7_ag.utils.torch_utils import (
    ModelEMA,
    select_device,
    intersect_dicts,
...
from YOLOv7_ag.utils.wandb_logging.wandb_utils import (
    WandbLogger,
    check_wandb_resume,
)
...
if __name__ == "__main__":
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        with open(
            "/data/projects/ecolplus/workspace/Script/ecol+/YOLOV7-AG/runs/train/yolov7-ag26/opt.yaml"
        ) as f:
